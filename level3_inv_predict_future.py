...
"""
Predict inventory future result of Level-3.
...
def update_future_for_level3_inv(model_config: Bunch,
                                 db_config: Bunch,
                                 start_pred_year: int,
    ...
    """Update inventory future result of level3."""

    # Step 1: Read in data
    # ============================================================================================ #

    data_loader = Level3InvDataLoader(start_pred_year, start_pred_month,
    ...
    df_preds_test['pred_inv_qty'] = df_preds_test.pred_inv_qty.apply(lambda x: x if x > 0 else 0)
    df_preds_test['pred_inv_qty'] = np.round(df_preds_test.pred_inv_qty, decimals=4 if need_unitize else 0)

    result = df_preds_test.join(df_test, how='left').reset_index()
    result.act_inv_qty.fillna(0, inplace=True)
...
if __name__ == '__main__':
    ...
    # Update future result of level3 inventory
    # ============================================================================================ #
    ...
    update_future_for_level3_inv(model_config=model_config,
                                 db_config=db_config,
